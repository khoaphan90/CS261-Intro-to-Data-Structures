...
*
* Overview:
* This program is a practice with dynamic arrays within C.
* Adding/removing elements to a dynamic array, dynamic stack and
* bag interfaces.
*
* Input:
* No user input.
...
void addDynArr(DynArr *v, TYPE val)
{
	...
	// check capacity, increase capacity if true
...
{	
	...
	// remove data and shift elements down
...
void removeDynArr(DynArr *v, TYPE val)
{
	...
	// check if val = data element, remove
	for (int i = 0; i < v->size; i++)
		if (EQ(val, v->data[i]))
			removeAtDynArr(v, i);
}
